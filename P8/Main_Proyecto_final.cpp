...
void saveAndLoadFrames(void)
{
	//Máximo 18 cuadros
	//Esta función se encarga de cargar las coordenadas de cada Keyframe del avión
	//Primer cuadro
	KeyFrame[0].posX = 5.0f;
	KeyFrame[0].posY = posY;
	KeyFrame[0].posZ = 14.0f;
	KeyFrame[0].rotAvion = -170.f;

	//Segundo cuadro
	KeyFrame[1].posX = 5.0f;
	KeyFrame[1].posY = posY;
	KeyFrame[1].posZ = 11.0f;
	KeyFrame[1].rotAvion = -170.0f;

	//Tercer cuadro
	KeyFrame[2].posX = 4.0f;
	KeyFrame[2].posY = posY;
	KeyFrame[2].posZ = 9.0f;
	KeyFrame[2].rotAvion = -150.0f;

	KeyFrame[3].posX = 4.0f;
	KeyFrame[3].posY = posY;
	KeyFrame[3].posZ = 7.0f;
	KeyFrame[3].rotAvion = -170.0f;

	KeyFrame[4].posX = 4.0f;
	KeyFrame[4].posY = posY;
	KeyFrame[4].posZ = 3.0f;
	KeyFrame[4].rotAvion = -130.0f;

	KeyFrame[5].posX = 2.0f;
	KeyFrame[5].posY = posY;
	KeyFrame[5].posZ = 3.0f;
	KeyFrame[5].rotAvion = -90.0f;

	KeyFrame[6].posX = 0.0f;
	KeyFrame[6].posY = posY;
	KeyFrame[6].posZ = 3.0f;
	KeyFrame[6].rotAvion = -50.0f;

	KeyFrame[7].posX = -4.0f;
	KeyFrame[7].posY = posY;
	KeyFrame[7].posZ = 3.0f;
	KeyFrame[7].rotAvion = -80.0f;

	KeyFrame[8].posX = -5.0f;
	KeyFrame[8].posY = posY;
	KeyFrame[8].posZ = 4.0f;
	KeyFrame[8].rotAvion = -25.0f;

	KeyFrame[9].posX = -6.0f;
	KeyFrame[9].posY = posY;
	KeyFrame[9].posZ = 6.0f;
	KeyFrame[9].rotAvion = 5.0f;

	KeyFrame[10].posX = -6.0f;
	KeyFrame[10].posY = posY;
	KeyFrame[10].posZ = 7.0f;
	KeyFrame[10].rotAvion = 40.0f;

	KeyFrame[11].posX = -5.0f;
	KeyFrame[11].posY = posY;
	KeyFrame[11].posZ = 9.0f;
	KeyFrame[11].rotAvion = 20.0f;

	KeyFrame[12].posX = -5.0f;
	KeyFrame[12].posY = posY;
	KeyFrame[12].posZ = 10.0f;
	KeyFrame[12].rotAvion = 5.0f;

	KeyFrame[13].posX = -6.0f;
	KeyFrame[13].posY = posY;
	KeyFrame[13].posZ = 11.0f;
	KeyFrame[13].rotAvion = -65.0f;

	KeyFrame[14].posX = -6.0f;
	KeyFrame[14].posY = posY;
	KeyFrame[14].posZ = 12.0f;
	KeyFrame[14].rotAvion = -10.0f;

	KeyFrame[15].posX = -6.0f;
	KeyFrame[15].posY = posY;
	KeyFrame[15].posZ = 13.0f;
	KeyFrame[15].rotAvion = 60.0f;

	KeyFrame[16].posX = 6.0f;
	KeyFrame[16].posY = posY;
	KeyFrame[16].posZ = 13.0f;
	KeyFrame[16].rotAvion = -85.0f;

	KeyFrame[17].posX = 6.0f;
	KeyFrame[17].posY = posY;
	KeyFrame[17].posZ = 13.0f;
	KeyFrame[17].rotAvion = 130.0f;
...
void interpolation(void)
{
	...
	rotAvionInc = (KeyFrame[playIndex + 1].rotAvion - KeyFrame[playIndex].rotAvion) / i_max_steps;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Carga la animación por maquina de estad
		animacion();
		...
		//Sillón doble
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-2.10 + 4.0f, 0.0f, 3.4f));  
		...
		//Mesa central sala
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-2.4 + 4.0f, 0.0f, 2.10f));  
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-2.4 + 4.0f, 0.225f, 2.10f));  
		...
		//Sofa individual 1
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-1.4+ 4.0f, 0.0f, 2.5f));  
		...
		//Sofa individual 2
		//model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-10.0 + 4.0f, 0.0f, 0.0f));  
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(1.55f, 0.0f, 0.08f));  
		model = glm::scale(model, glm::vec3(0.17f, 0.17f, 0.17));	 
		...
		//Mesa tv
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.30f, 0.0f, 0.30));  
		//model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));	 
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.40f, 0.20f, 0.4f));  
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(3.64, 0.0f, 3.45+0.12));  
		model = glm::scale(model, glm::vec3(0.12, 0.1f, 0.08+0.02));	 
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(glGetUniformLocation(lightingShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(3.7f, 0.0f, 1.6));  
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(2.77, -0.39, 3.05));  
		model = glm::scale(model, glm::vec3(1.36f, 1.52f, 1.2f));	 
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(4.0f + posX, 6.0f + posY, -5.0f + posZ));  
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(5.0f, 1.05f, 3.5f));  
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.03, 0.85, 4.90f));  
		model = glm::scale(model, glm::vec3(0.3f));	 
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(glGetUniformLocation(lightingShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
