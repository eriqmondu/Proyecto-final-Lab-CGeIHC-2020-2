...
int main()
{
	...
	Model Mymodel((char*)"Models/city.obj");
	...
	glGenTextures(1, &texture1); //Textura difusa
	glGenTextures(1, &texture2); //Textura especular
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Cambiar color de las 4 point light, diferentes tonalidades	
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].specular"), 1.0f, 1.0f, 1.0f); //BLANCO
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].diffuse"), 0.215, 0.921, 0.435);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].specular"), 0.215, 0.921, 0.435); //Verde pasto
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].diffuse"), 0.874, 0.215, 0.921); //Morado
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].specular"), 0.874, 0.215, 0.921);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[3].constant"), 1.0f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[3].linear"), 0.09f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[3].quadratic"), 0.032f);

		// SpotLight
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.position"), 0.7, 0.2, 2.0); //Pegada a la camara
																						//Cambiar de posición y dirección de la Spotlight
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), 0.0f, 0.0f, -1.0f); //Vector forward de la camara
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.ambient"), 0.921, 0.6, 0.8f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.diffuse"), 0.921, 0.6, 0.8); //Anaranjado
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.outerCutOff"), glm::cos(glm::radians(16.0f))); //Cono exterior
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mode)
{
	...
	if (keys[GLFW_KEY_SPACE])
	{
		active = !active;
		if (active)
			LightP1 = glm::vec3(0.215, 0.917, 0.921); //Color cyan
		else
